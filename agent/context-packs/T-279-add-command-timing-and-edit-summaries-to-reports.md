# T-279: Add command timing and edit summaries to reports
...
- `docs/**`
- `agent/context-packs/T-279-add-command-timing-and-edit-summaries-to-reports.md`
- `agent/workflows/W-279-add-command-timing-and-edit-summaries-to-reports.md`
...
| `agent/context-packs/T-279-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
| `agent/workflows/W-279-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
