# T-275: Add command timing and edit summaries to reports
...
- `docs/**`
- `agent/context-packs/T-275-add-command-timing-and-edit-summaries-to-reports.md`
- `agent/workflows/W-275-add-command-timing-and-edit-summaries-to-reports.md`
...
| `agent/context-packs/T-275-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
| `agent/workflows/W-275-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
