# T-282: Add command timing and edit summaries to reports
...
- `docs/**`
- `agent/context-packs/T-282-add-command-timing-and-edit-summaries-to-reports.md`
- `agent/workflows/W-282-add-command-timing-and-edit-summaries-to-reports.md`
...
| `agent/context-packs/T-282-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
| `agent/workflows/W-282-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
