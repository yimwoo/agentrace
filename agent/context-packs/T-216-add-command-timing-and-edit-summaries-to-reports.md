# T-216: Add command timing and edit summaries to reports
...
- `docs/**`
- `agent/context-packs/T-216-add-command-timing-and-edit-summaries-to-reports.md`
- `agent/workflows/W-216-add-command-timing-and-edit-summaries-to-reports.md`
...
| `agent/context-packs/T-216-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
| `agent/workflows/W-216-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
