# T-227: Add command timing and edit summaries to reports
...
- `docs/**`
- `agent/context-packs/T-227-add-command-timing-and-edit-summaries-to-reports.md`
- `agent/workflows/W-227-add-command-timing-and-edit-summaries-to-reports.md`
...
| `agent/context-packs/T-227-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
| `agent/workflows/W-227-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
