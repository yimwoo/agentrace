# T-225: Add command timing and edit summaries to reports
...
- `docs/**`
- `agent/context-packs/T-225-add-command-timing-and-edit-summaries-to-reports.md`
- `agent/workflows/W-225-add-command-timing-and-edit-summaries-to-reports.md`
...
| `agent/context-packs/T-225-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
| `agent/workflows/W-225-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
