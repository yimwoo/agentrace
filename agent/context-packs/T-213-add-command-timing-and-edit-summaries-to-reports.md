# T-213: Add command timing and edit summaries to reports
...
- `docs/**`
- `agent/context-packs/T-213-add-command-timing-and-edit-summaries-to-reports.md`
- `agent/workflows/W-213-add-command-timing-and-edit-summaries-to-reports.md`
...
| `agent/context-packs/T-213-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
| `agent/workflows/W-213-add-command-timing-and-edit-summaries-to-reports.md` | inferred; lifecycle write-back |
