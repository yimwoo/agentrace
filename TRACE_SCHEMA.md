...
command duration source counts, duration recorded/missing counts and coverage ratio, aggregate command time window, the average, average recorded-only, median, and range of command durations, first, slowest, fastest, and last command identities with
...
distribution, edit-kind counts and per-kind timing/line-impact totals with artifacts, failed edit identities with timing/error context, edit duration source counts, edit duration recorded/missing counts and coverage ratio, aggregate edit time window, average
