...
repeated command retries, grouped summary coverage by command duration source/status/identity/working directory and edit duration source/status/kind/path, per-command attempt totals with attempt-level duration-source counts/totals/shares, repeated-group summary recorded/missing counts and coverage ratios, time windows, and artifacts, command working-directory counts, cwd duration totals/averages/min-max extremes/coverage/shares and dominant cwd highlights, per-cwd timing totals with duration-source counts/totals/shares and artifacts, failed command identities with timing/failure context, command exit-code distributions, command status counts,
...
their timing context and command summaries when present, changed-file list, per-file change totals with file-level duration-source counts/totals/shares, repeated file/edit-kind summary recorded/missing counts and coverage ratios, time windows, and artifacts, net line delta, edit failure counts/status
distribution, edit status-duration totals/averages/min-max extremes/coverage/shares with a dominant status highlight, edit-kind counts, edit-kind duration totals/averages/min-max extremes/coverage/shares and dominant kind highlights, per-kind timing/line-impact totals with duration-source counts/totals/shares and artifacts, failed edit identities with timing/error context, failed command identities with working-directory context, edit duration source counts plus duration totals/averages/shares by source, edit duration recorded/missing counts and coverage ratio, edit summary recorded/missing counts and coverage ratio, aggregate edit time window, average
