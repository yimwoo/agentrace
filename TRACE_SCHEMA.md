...
`average_duration_ms`, `median_duration_ms`, `failed_count`, `failed_commands`, `exit_code_counts`, `status_counts`, `duration_source_counts`,
...
command duration source counts, duration recorded/missing counts and coverage ratio, aggregate command time window, the average, median, and range of command durations, first, slowest, fastest, and last command identities with
