...
command duration source counts, aggregate command time window, the average, median, and range of command durations, first, slowest, fastest, and last command identities with
