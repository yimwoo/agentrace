`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank values. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter those latest binary rank states without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-283` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose a sortable binary rank for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank states. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort those active/inactive enum states without parsing strings.

Session notes:
- created AgentSpec task `T-282` for the next active coverage-duration-share priority reason detail rank companion
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter those rank states without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-281` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status values
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose a sortable binary rank for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank statuses. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort those active/inactive enum states without parsing strings.

Session notes:
- created AgentSpec task `T-280` for the next active coverage-duration-share priority reason detail rank companion
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank states without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-279` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank statuses without parsing strings.

Session notes:
- created AgentSpec task `T-278` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank status ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank states without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-277` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank states. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank statuses without parsing strings.

Session notes:
- created AgentSpec task `T-276` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

- top-level JSON and Markdown reports now include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status-rank status-rank status-rank status-rank status-rank status-rank status-rank ranks with stable active/inactive strings without parsing numeric 0/1 values.
`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status-rank states. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank status-rank status-rank status-rank status-rank status-rank status-rank statuses without parsing strings.

Session notes:
- created AgentSpec task `T-274` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank status-rank ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status-rank status ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status-rank status-rank status-rank status-rank status-rank status ranks without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-273` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank status-rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank status-rank status-rank status-rank status-rank status-rank statuses without parsing strings.

Session notes:
- created AgentSpec task `T-272` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status-rank status-rank status-rank status-rank status ranks without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-271` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status-rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank status values. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank status-rank status-rank status-rank status-rank status values without parsing strings.

Session notes:
- created AgentSpec task `T-270` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank status ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status-rank status-rank ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status-rank status-rank status-rank status-rank ranks without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-269` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank status-rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff
...
Session notes:
- created AgentSpec task `T-267` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status-rank rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- carried forward pending T-266 AgentSpec lifecycle/code artifacts and refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank status values. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank status-rank status-rank status values without parsing strings.

Session notes:
- created AgentSpec task `T-266` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank status ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status-rank ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status-rank status-rank ranks without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-265` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank status-rank status-rank statuses without parsing strings.

Session notes:
- created AgentSpec task `T-264` for active coverage-duration-share priority reason detail active status-rank status-rank status-rank ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status-rank status ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status-rank status ranks without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-263` for active coverage-duration-share priority reason detail active status-rank status-rank status rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank status-rank statuses without parsing strings.

Session notes:
- created AgentSpec task `T-262` for active coverage-duration-share priority reason detail active status-rank status-rank status ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now expose active/inactive enum statuses for active coverage-duration-share priority reason detail status-rank status ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can filter active status-rank status ranks without parsing numeric 0/1 values.

Session notes:
- created AgentSpec task `T-261` for active coverage-duration-share priority reason detail active status-rank status rank statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active/inactive enum statuses for active coverage-duration-share priority reason detail status ranks. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active status-rank enum values without parsing strings.

Session notes:
- created AgentSpec task `T-260` for active coverage-duration-share priority reason detail active status-rank status ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff
...
Session notes:
- created AgentSpec task `T-257` for active coverage-duration-share priority reason detail active statuses
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank active coverage-duration-share priority reason details. JSON and Markdown include `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort active reason details as 0/1 values without parsing booleans or status strings.

Session notes:
- created AgentSpec task `T-256` for active coverage-duration-share priority reason detail ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff
...
Session notes:
- created AgentSpec task `T-253` for coverage-vs-duration-share skew action priority status reason detail ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_status_reason_detail_rank=` in Markdown
...
Session notes:
- created AgentSpec task `T-245` for coverage-vs-duration-share skew action priority ranks
- added `summary_text_coverage_duration_share_gap_attention_action_priority_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_action_priority_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff
...
Session notes:
- created AgentSpec task `T-241` for coverage-vs-duration-share skew attention ranks
- added `summary_text_coverage_duration_share_gap_attention_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_attention_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff
...
Session notes:
- created AgentSpec task `T-239` for coverage-vs-duration-share skew direction labels
- added `summary_text_coverage_duration_share_gap_direction` to JSON summary text metrics and rendered `coverage_duration_share_gap_direction=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff

`agentrace` reports now rank summary row coverage versus summarized-duration share skew for command/edit report summaries. JSON and Markdown include `summary_text_coverage_duration_share_gap_rank` inside `report_summary_text_metrics` for command, edit, and combined activity rows, so reviewers can sort no/low/medium/high normalized coverage-vs-duration-share skew numerically without parsing label text.

Session notes:
- created AgentSpec task `T-238` for coverage-vs-duration-share skew ranks
- added `summary_text_coverage_duration_share_gap_rank` to JSON summary text metrics and rendered `coverage_duration_share_gap_rank=` in Markdown
- refreshed regression expectations, schema/state docs, rich Markdown fixture, and this handoff
