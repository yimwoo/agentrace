...
- JSON and Markdown reports now surface command timing rows, file edit summaries with per-row net line deltas, linked command-log/diff artifact references, row duration sources, and available start/end timestamp context
