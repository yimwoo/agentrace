...
- aggregate JSON and Markdown report totals now show command count/duration/failures/slowest command plus changed-file count/list, line delta, and total edit duration
