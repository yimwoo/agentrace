...
def _format_report_summary_text_metrics(metrics):
    ...
    for label in ["command", "edit", "activity"]:
        ...
        parts.append(
            ...
            f"missing={row.get('summary_text_missing_ratio', 0)},"
            f"duration_ms={row.get('summary_text_duration_ms', 0)},"
            f"summarized_duration_ms={row.get('summary_text_summarized_duration_ms', 0)},"
            f"unsummarized_duration_ms={row.get('summary_text_unsummarized_duration_ms', 0)},"
            f"summarized_average_duration_ms={row.get('summary_text_summarized_average_duration_ms', 0)},"
            f"unsummarized_average_duration_ms={row.get('summary_text_unsummarized_average_duration_ms', 0)},"
            f"average_duration_delta_ms={row.get('summary_text_average_duration_delta_ms', 0)},"
            ...
            f"average_duration_gap_direction={row.get('summary_text_average_duration_gap_direction', 'balanced_average_duration')},"
            ...
            f"coverage_duration_share_gap_attention_status={row.get('summary_text_coverage_duration_share_gap_attention_status', 'no_coverage_duration_share_gap_attention_needed')},"
            ...
            f"coverage_duration_share_gap_attention_action_priority_status_reason={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason', 'coverage_duration_share_gap_absent')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail', 'priority_status_inactive_because_coverage_duration_share_gap_absent')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_status', 'coverage_duration_share_gap_priority_reason_detail_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active', False)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status', 'coverage_duration_share_gap_priority_reason_detail_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank', 0)},"
            f"coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status={row.get('summary_text_coverage_duration_share_gap_attention_action_priority_status_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status', 'coverage_duration_share_gap_priority_reason_detail_active_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_status_rank_inactive')},"
            ...
            f"summarized_duration_ms_per_char={row.get('summary_text_summarized_duration_ms_per_char', 0)},"
...
def _format_report_summary_timing_window_impact(impact):
    ...
    for label in ["command", "edit", "activity"]:
        ...
        parts.append(
            ...
            f"complete_window_count_delta={row.get('summary_complete_window_count_delta', 0)}/"
            f"complete_window_count_delta_abs="
            f"{row.get('summary_complete_window_count_delta_abs', abs(row.get('summary_complete_window_count_delta', 0)))}/"
            f"complete_window_count_delta_abs_share={row.get('summary_complete_window_count_delta_abs_share', 0)}/"
            ...
            f"missing_window_excess_share={row.get('summary_missing_window_excess_share', 0)}/"
            ...
            f"complete_window_duration_total_ms={row.get('summary_complete_window_duration_total_ms', 0)}/"
            f"complete_window_duration_total_share={row.get('summary_complete_window_duration_total_share', 0)}/"
            f"complete_window_duration_delta_ms={row.get('summary_complete_window_duration_delta_ms', 0)}/"
            f"complete_window_duration_delta_label="
            f"{row.get('summary_complete_window_duration_delta_label', 'balanced_complete_window_duration_delta')}/"
            f"complete_window_duration_delta_abs_ms="
            f"{row.get('summary_complete_window_duration_delta_abs_ms', abs(row.get('summary_complete_window_duration_delta_ms', 0)))}/"
            f"complete_window_duration_delta_abs_share={row.get('summary_complete_window_duration_delta_abs_share', 0)}/"
            f"complete_window_duration_delta_share={row.get('summary_complete_window_duration_delta_share', 0)}/"
            f"complete_window_duration_ratio={row.get('summary_complete_window_duration_ratio', 0)}/"
            f"complete_window_duration_ratio_label={row.get('summary_complete_window_duration_ratio_label', 'no_complete_window_duration')}/"
            ...
            f"missing_window_duration_delta_ms={row.get('summary_missing_window_duration_delta_ms', 0)}/"
            f"missing_window_duration_delta_label="
            f"{row.get('summary_missing_window_duration_delta_label', 'balanced_missing_window_duration_delta')}/"
            f"missing_window_duration_delta_abs_ms="
            f"{row.get('summary_missing_window_duration_delta_abs_ms', abs(row.get('summary_missing_window_duration_delta_ms', 0)))}/"
            f"missing_window_duration_total_ms={row.get('summary_missing_window_duration_total_ms', 0)}/"
            f"missing_window_duration_total_share={row.get('summary_missing_window_duration_total_share', 0)}/"
            f"missing_window_duration_delta_abs_share="
            f"{row.get('summary_missing_window_duration_delta_abs_share', 0)}/"
            f"missing_window_duration_delta_share={row.get('summary_missing_window_duration_delta_share', 0)}/"
            ...
            f"missing_window_duration_ratio_label="
            f"{row.get('summary_missing_window_duration_ratio_label', 'no_missing_window_duration')}/"
            ...
            f"{row.get('summary_missing_window_excess_attention_label', 'no_missing_summary_window_excess')}/"
            ...
            f"complete_window_share_delta={row.get('summary_complete_window_share_delta', 0)}/"
            ...
            f"complete_window_duration_share_delta="
            f"{row.get('summary_complete_window_duration_share_delta', 0)}/"
            f"complete_window_coverage_label="
            f"{row.get('summary_complete_window_coverage_label', 'balanced_complete_window_coverage')}/"
            ...
            f"missing_window_gap_delta_max={row.get('summary_missing_window_gap_delta_max', 0)}/"
            ...
            f"missing_window_gap_delta_comparison_label="
            f"{row.get('summary_missing_window_gap_delta_comparison_label', 'balanced_missing_summary_gap_signals')}/"
            f"missing_window_gap_delta_comparison_attention_label="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_label', 'no_missing_summary_gap_signal_divergence')}/"
            f"missing_window_gap_delta_comparison_attention_rank="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_rank', 0)}/"
            f"missing_window_gap_delta_comparison_attention_required="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_required', False)}/"
            f"missing_window_gap_delta_comparison_attention_status="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_status', 'no_missing_summary_gap_signal_attention_needed')}/"
            f"missing_window_gap_delta_comparison_attention_trigger="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_trigger', 'no_missing_summary_gap_signal_attention_trigger')}/"
            f"missing_window_gap_delta_comparison_attention_trigger_signal="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_trigger_signal', 'none')}/"
            f"missing_window_gap_delta_comparison_attention_trigger_signal_label="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_trigger_signal_label', 'no_missing_summary_gap_signal_family')}/"
            f"missing_window_gap_delta_comparison_attention_trigger_signal_rank="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_trigger_signal_rank', 0)}/"
            f"missing_window_gap_delta_comparison_attention_trigger_signal_required="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_trigger_signal_required', False)}/"
            f"missing_window_gap_delta_comparison_attention_trigger_signal_status="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_trigger_signal_status', 'no_missing_summary_gap_trigger_signal_attention_needed')}/"
            f"missing_window_gap_delta_comparison_attention_trigger_signal_action="
            f"{row.get('summary_missing_window_gap_delta_comparison_attention_trigger_signal_action', 'no_missing_summary_gap_trigger_signal_action')}/"
            f"missing_window_gap_delta_comparison_attention_trigger_signal_action_label="
