...
def test_report_summary_coverage_groups_explanations_by_report_labels():
    ...
    assert "report_summary_duration_impact: command=recorded_duration_count=1/missing_duration_count=1/total_duration_count=2/recorded_duration_ms=10/recorded_average_duration_ms=10.0/recorded_median_duration_ms=10/recorded_duration_range_ms=0/recorded_duration_extremes_ms={'min': 10, 'max': 10}/recorded_duration_source_counts=explicit=1/missing_duration_ms=5/missing_average_duration_ms=5.0/missing_median_duration_ms=5/missing_duration_range_ms=0/missing_duration_extremes_ms={'min': 5, 'max': 5}/missing_duration_source_counts=derived=1/missing_duration_share=0.3333/largest_missing_duration_ms=5/largest_missing_duration_share=1.0/missing_duration_examples=`ruff check` (event=evt_cmd_without_summary, status=failed, duration_ms=5, duration_source=derived, cwd=repo, exit_code=1); edit=recorded_duration_count=1/missing_duration_count=0/total_duration_count=1/recorded_duration_ms=3/recorded_average_duration_ms=3.0/recorded_median_duration_ms=3/recorded_duration_range_ms=0/recorded_duration_extremes_ms={'min': 3, 'max': 3}/recorded_duration_source_counts=explicit=1/missing_duration_ms=0/missing_average_duration_ms=0/missing_median_duration_ms=0/missing_duration_range_ms=0/missing_duration_extremes_ms={'min': 0, 'max': 0}/missing_duration_source_counts=none/missing_duration_share=0.0/largest_missing_duration_ms=0/largest_missing_duration_share=0/missing_duration_examples=none; activity=recorded_duration_count=2/missing_duration_count=1/total_duration_count=3/recorded_duration_ms=13/recorded_average_duration_ms=6.5/recorded_median_duration_ms=6.5/recorded_duration_range_ms=7/recorded_duration_extremes_ms={'min': 3, 'max': 10}/recorded_duration_source_counts=explicit=2/missing_duration_ms=5/missing_average_duration_ms=5.0/missing_median_duration_ms=5/missing_duration_range_ms=0/missing_duration_extremes_ms={'min': 5, 'max': 5}/missing_duration_source_counts=derived=1/missing_duration_share=0.2778/largest_missing_duration_ms=5/largest_missing_duration_share=1.0/missing_duration_examples=`ruff check` (event=evt_cmd_without_summary, status=failed, duration_ms=5, duration_source=derived, cwd=repo, exit_code=1)" in text
