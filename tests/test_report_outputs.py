...
def test_summary_coverage_includes_missing_summary_duration_impact():
    ...
    text = build_markdown_summary(trace)
    assert "command=recorded_duration_count=1/missing_duration_count=1/total_duration_count=2/recorded_duration_ms=25/missing_duration_ms=75/missing_duration_share=0.75/largest_missing_duration_ms=75/largest_missing_duration_share=1.0/missing_duration_examples=`python scripts/slow.py` (event=evt_cmd_unsummarized, status=succeeded, duration_ms=75, duration_source=explicit, exit_code=0)" in text
    assert "edit=recorded_duration_count=0/missing_duration_count=1/total_duration_count=1/recorded_duration_ms=0/missing_duration_ms=20/missing_duration_share=1.0/largest_missing_duration_ms=20/largest_missing_duration_share=1.0/missing_duration_examples=src/slow.py (event=evt_edit_unsummarized, status=succeeded, duration_ms=20, duration_source=explicit, kind=modify, net=1)" in text
    assert "activity=recorded_duration_count=1/missing_duration_count=2/total_duration_count=3/recorded_duration_ms=25/missing_duration_ms=95/missing_duration_share=0.7917/largest_missing_duration_ms=75/largest_missing_duration_share=0.7895/missing_duration_examples=`python scripts/slow.py` (event=evt_cmd_unsummarized, status=succeeded, duration_ms=75, duration_source=explicit, exit_code=0); src/slow.py (event=evt_edit_unsummarized, status=succeeded, duration_ms=20, duration_source=explicit, kind=modify, net=1)" in text
