...
def test_report_summary_text_metrics_quantify_command_and_edit_summary_detail():
    ...
    assert "- report_summary_text_metrics: command=count=1,total_chars=9,average_chars=9.0,min_chars=9,max_chars=9,empty=1,coverage=0.5,missing=0.5" in markdown
    assert "edit=count=1,total_chars=13,average_chars=13.0,min_chars=13,max_chars=13,empty=0,coverage=1.0,missing=0.0" in markdown
    assert "activity=count=2,total_chars=22,average_chars=11.0,min_chars=9,max_chars=13,empty=1,coverage=0.6667,missing=0.3333" in markdown
