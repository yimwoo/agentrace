...
def test_report_summary_coverage_groups_explanations_by_report_labels():
    ...
    assert "report_summary_duration_impact: command=recorded_duration_count=1/missing_duration_count=1/total_duration_count=2/recorded_duration_ms=10/missing_duration_ms=5/missing_average_duration_ms=5.0/missing_duration_share=0.3333/largest_missing_duration_ms=5/largest_missing_duration_share=1.0/missing_duration_examples=`ruff check` (event=evt_cmd_without_summary, status=failed, duration_ms=5, duration_source=derived, cwd=repo, exit_code=1); edit=recorded_duration_count=1/missing_duration_count=0/total_duration_count=1/recorded_duration_ms=3/missing_duration_ms=0/missing_average_duration_ms=0/missing_duration_share=0.0/largest_missing_duration_ms=0/largest_missing_duration_share=0/missing_duration_examples=none; activity=recorded_duration_count=2/missing_duration_count=1/total_duration_count=3/recorded_duration_ms=13/missing_duration_ms=5/missing_average_duration_ms=5.0/missing_duration_share=0.2778/largest_missing_duration_ms=5/largest_missing_duration_share=1.0/missing_duration_examples=`ruff check` (event=evt_cmd_without_summary, status=failed, duration_ms=5, duration_source=derived, cwd=repo, exit_code=1)" in text
