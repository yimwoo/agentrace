...
def test_report_summary_timing_window_impact_splits_complete_windows_by_summary_presence():
    ...
    assert "command=recorded_complete_windows=1/missing_complete_windows=0/complete_window_count_delta=-1/complete_window_count_delta_abs=1/complete_window_count_delta_abs_share=1.0/recorded_missing_windows=0/missing_missing_windows=1" in text
    ...
    assert "activity=recorded_complete_windows=1/missing_complete_windows=0/complete_window_count_delta=-1/complete_window_count_delta_abs=1/complete_window_count_delta_abs_share=1.0/recorded_missing_windows=1/missing_missing_windows=1" in text
