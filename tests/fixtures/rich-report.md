...
- report_summary_duration_impact: command=recorded_duration_ms=0/missing_duration_ms=3200/missing_duration_share=1.0/missing_duration_examples=`pytest tests/test_auth.py -q` (event=evt_cmd_1, status=failed, duration_ms=3200, duration_source=explicit, cwd=/workspace/app, exit_code=1); edit=recorded_duration_ms=125/missing_duration_ms=0/missing_duration_share=0.0/missing_duration_examples=none; activity=recorded_duration_ms=125/missing_duration_ms=3200/missing_duration_share=0.9624/missing_duration_examples=`pytest tests/test_auth.py -q` (event=evt_cmd_1, status=failed, duration_ms=3200, duration_source=explicit, cwd=/workspace/app, exit_code=1)
- command_count: 1
