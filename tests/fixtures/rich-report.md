...
- command_status_duration_summary: status_duration_ms=failed=3200, status_average_duration_ms=failed=3200.0, status_duration_extremes_ms=failed=min=3200/max=3200, status_duration_share=failed=1.0, dominant_duration_status=failed (3200ms, share=1.0)
...
- edit_status_duration_summary: status_duration_ms=succeeded=125, status_average_duration_ms=succeeded=125.0, status_duration_extremes_ms=succeeded=min=125/max=125, status_duration_share=succeeded=1.0, dominant_duration_status=succeeded (125ms, share=1.0)
