...
- report_inspection_targets: pytest tests/test_auth.py -q (event=evt_cmd_1, type=command, reason=failed_activity, status=failed, duration_ms=3200, duration_source=explicit, detail=failed status or non-zero command exit code, cwd=/workspace/app, exit_code=1); pytest tests/test_auth.py -q (event=evt_cmd_1, type=command, reason=missing_command_summary, status=failed, duration_ms=3200, duration_source=explicit, detail=command row has no human-readable summary, cwd=/workspace/app, exit_code=1); pytest tests/test_auth.py -q (event=evt_cmd_1, type=command, reason=slowest_activity, status=failed, duration_ms=3200, duration_source=explicit, detail=largest recorded duration in command/edit activity timeline, cwd=/workspace/app, exit_code=1)
